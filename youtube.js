var config = {
    clientId: '843488876073-cefvojr0l7vk571ut57jhhbf8b4f6n45.apps.googleusercontent.com',
    redirectUri: 'http://localhost:8888/YouTube/youtube.html',
...
myConnector.getColumnHeaders = function() {
    fieldNames = ["Video ID","Channel ID","Views","Likes","Dislikes","Comments","Shares","Estimated Minutes Watched","Avg View Duration (s)"];
    var fieldTypes = ["string","string","int","int","int","int","int","int","int"];
